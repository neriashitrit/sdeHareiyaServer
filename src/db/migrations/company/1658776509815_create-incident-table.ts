...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.createTable(COMPANIES_TABLES.INCIDENT, {
    ...
    sla_assign: { type: PgType.TIMESTAMP_WITHOUT_TIME_ZONE },
    sla_initial_triage: { type: PgType.TIMESTAMP_WITHOUT_TIME_ZONE },
    sla_time_to_resolve: { type: PgType.TIMESTAMP_WITHOUT_TIME_ZONE },
