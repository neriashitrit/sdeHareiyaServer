...
export async function up(pgm: MigrationBuilder): Promise<void> {
  pgm.renameColumn(Tables.COMPANY_DETAILS, 'company_id_number', 'company_identity_number')
  pgm.renameColumn(Tables.COMPANY_DETAILS, 'company_name', 'incorporation_name')
...
export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.renameColumn(Tables.COMPANY_DETAILS, 'company_identity_number', 'company_id_number')
  pgm.renameColumn(Tables.COMPANY_DETAILS, 'incorporation_name', 'company_name')
