...
export const getAccessToken = async () :Promise<string> => {
	...
	if (!clientId || !clientSecret || !tenantID)  throw new Error('Define AD_CLIENT_ID and AD_CLIENT_SECRET and AZURE_TENANT_ID in env');
...
export const createAdminUserInB2C = async (firstName: string, lastName: string, email: string, phone: string,): Promise<any> => {
